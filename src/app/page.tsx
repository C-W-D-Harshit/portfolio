...
export default function Home() {
  return (
    <main className="h-full w-full flex items-center justify-center py-12 px-6">
      ...
      <div className="h-full w-full max-w-screen-xl flex flex-col lg:flex-row">
        <div className="h-full w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <div className="flex items-center gap-2 text-secondary text-2xl lg:text-4xl font-semibold lg:font-medium my-2 mb-8 lg:mb-20">
